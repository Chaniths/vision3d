    ...
    <div className="bg-white max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700">
            Immerse your clients in a realistic and interactive 360° tour of
            your projects.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
        <div className="order-2 md:order-1">
          ...
          <p className="text-gray-700">
            Collect images, ideas and inspiration easily to personalize your
            space.
          </p>
        </div>
        ...
        <div className="order-1 md:order-2">
          <Image
            src="/home_solution_section/image 19.svg"
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 items-center">
        <div className="relative">
          <div className="bg-amber-50 rounded-lg p-4 flex justify-center items-center">
            <div className="relative">
              <Image
                src="/home_solution_section/image 20.svg"
        ...
        <div>
          ...
          <p className="text-gray-700">
            Easily import custom 3D models to enrich your designs with
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="order-2 md:order-1">
          ...
          <p className="text-gray-700">
            Access to your designs from anywhere and Seamlessly toggle between
            budget and luxury options.
          </p>
        </div>
        <div className="order-1 md:order-2">
          <Image
            src="/home_solution_section/tempImagep16n8k.svg"
            alt="Designer accessing designs on laptop"
            width={500}
            height={350}
            className="w-full rounded-lg shadow-lg"
