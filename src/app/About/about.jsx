...
export const About = () => {
    return (
        <div className="p-4">
            ...
            <p>
                Recognizing the challenges many face with intricate design platforms, we set out to create a
                solution that bridges the gap between creativity and technology. What began as a passion project
                has evolved into a comprehensive platform that empowers users to bring their visions to life
                effortlessly.
            </p>
            ...
            <p>
                As we continue to grow and evolve, we invite you to be part of our journey. Whether you're <br />
                an experienced architect or just starting out, Vision-3D is here to support and inspire your <br />
                creative endeavors.
            </p>
