...
const Footer = () => {
  return (
    <footer className="w-full bg-[#0a1929] text-white py-8">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between md:space-y-0 space-y-6">
          ...
          {/* Content Links */}
          <div className="md:mb-0">
            <h3 className="text-sm font-medium mb-3 pb-1 border-b border-[#f45d96] inline-block">Content</h3>
            <ul className="space-y-2 mt-3">
              <li><Link href="/" className="text-gray-300 hover:text-white transition">Home</Link></li>
              <li><Link href="/inspiration" className="text-gray-300 hover:text-white transition">Inspiration</Link></li>
              <li><Link href="/resouces" className="text-gray-300 hover:text-white transition">Resources</Link></li>
              <li><Link href="/design" className="text-gray-300 hover:text-white transition">Design</Link></li>
          ...
          {/* Follow Us */}
          <div className="md:mb-0">
            <h3 className="text-sm font-medium mb-3 pb-1 border-b border-[#f45d96] inline-block">Follow Us</h3>
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
          © 2025 Vision 3D | All Rights Reserved
        </div>
      </div>
    </footer>
  );
