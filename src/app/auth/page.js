        ...
        >
            ...
            <div className="w-[400px] backdrop-blur-sm bg-gray-800/60 text-white rounded-xl overflow-hidden shadow-2xl z-10">
                ...
                <div className="px-8 pb-8">
                    ...
                    <div className="mb-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-3 py-2 bg-white text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                            <button
                    ...
                    {/* Sign In Button */}
                    <button className="w-full bg-blue-800 hover:bg-blue-700 text-white font-medium py-2 rounded-md transition duration-200 mb-4">
                        Sign in
                    </button>
                    ...
                    <div className="flex justify-center space-x-4">
                        <button className="bg-white p-2 rounded-md w-12 h-12 flex items-center justify-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12 23C14.97 23 17.46 22.02 19.28 20.34L15.71 17.57C14.74 18.19 13.48 18.58 12 18.58C9.16 18.58 6.8 16.68 5.96 14.12H2.27V16.96C4.08 20.57 7.77 23 12 23Z" fill="#34A853" />
                                <path d="M5.96 14.12C5.74 13.44 5.62 12.73 5.62 12C5.62 11.27 5.74 10.56 5.96 9.88V7.04H2.27C1.46 8.55 1 10.22 1 12C1 13.78 1.46 15.45 2.27 16.96L5.96 14.12Z" fill="#FBBC05" />
                                <path d="M12 5.42C13.62 5.42 15.06 5.96 16.19 7.03L19.36 3.86C17.45 2.09 14.97 1 12 1C7.77 1 4.08 3.43 2.27 7.04L5.96 9.88C6.8 7.32 9.16 5.42 12 5.42Z" fill="#EA4335" />
                            </svg>
                        </button>
                        <button className="bg-white p-2 rounded-md w-12 h-12 flex items-center justify-center">
