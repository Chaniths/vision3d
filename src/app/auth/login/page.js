...
export default function Login() {
    ...
    const saveUser = () => {
        setUsers(prevUsers => [...prevUsers, { username: formData.email, password: formData.password }]);
                            ...
                            >
                                {showPassword ? (
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                        ...
                                        <path d="M12 4.5C7 4.5 2.73 7.61 1 12C1.89 14.2 3.37 16.03 5.26 17.26L12 10.5L17.73 16.23C19.63 14.99 21.1 13.16 22 11C20.27 6.61 16 4.5 12 4.5Z" fill="currentColor" />
                                    </svg>
                                ) : (
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
