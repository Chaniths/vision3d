  ...
  const posts = [
    {
      ...
      content:
        "Hi friends, I'm having issues with rendering my 3D design. The textures look blurry, and some objects don't appear as they should. I've checked my settings, but I can't figure out what's wrong. Does anyone know how to fix this? Any tips would be appreciated!",
      likes: 5,
      comments: 3,
    },
    {
      ...
      content:
        "Hello designers, I just completed a modern living room, but something feels off. I've experimented with different layouts and lighting, but it still doesn't look quite right. Could you take a look and share your suggestions? I'd love to improve it with your insights!",
      likes: 8,
      comments: 5,
    },
    {
      ...
      content:
        "Hey, I need to export my 3D design in high resolution, but every time I do, the image turns out pixelated. Are there specific settings I should change to get a crisp and clear export? Also, what's the best format for sharing online? Any tips would be appreciated!",
      likes: 7,
      comments: 4,
    },
    {
      ...
      content:
        "Hi friends, I'm working on a futuristic home design and would love to collaborate with someone who has experience with lighting and material textures. If anyone is interested, let's connect and create something awesome together!",
      likes: 10,
      comments: 6,
    },
  ];
  ...
  return (
    <>
      <div className="ml-[30px]">
        <p className="text-3xl font-bold p-4 m-4">Resources & Support</p>
        <p className="text-xl font-light pl-4 ml-4">
          Find everything you need to learn, troubleshoot, and connect with the
          community in one place. Whether <br></br>you’re a beginner or an
          experienced designer, our resources will help you make the most of
          Vision 3D.
        </p>
        ...
        <p className="text-3xl font-bold p-4 m-4">Still have questions?</p>
        ...
        <div className="text-xl font-serif pl-4 ml-4 mt-10">
          ...
          <p className="text-lg font-light pl-20 ml-4">
            Ask other users and get help from experienced designers
          </p>
        </div>
        ...
        <div className="text-xl font-serif pl-4 ml-4 mt-10">
          → Check our Tutorials
          <p className="text-lg font-light pl-20 ml-4">
            Browse step-by-step guides and video lessons
          </p>
        </div>
        ...
        <p className="text-3xl font-bold p-4 m-4">💬 Community Forum</p>
        ...
        <div className="max-w-7xl mx-auto bg-gray-300 rounded-lg shadow-sm border border-gray-500 float-left mb-20">
          <div className="p-6 border-b border-gray-400">
            <h1 className="text-2xl font-bold text-gray-900">
              3D Design Discussion Forum
            </h1>
            <p className="text-gray-600">
              Share your designs, get feedback, and connect with other designers
            </p>
          </div>
